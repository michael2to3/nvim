...
_G.packer_plugins = {
  ...
  ["java-debug"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/michael/.local/share/nvim/site/pack/packer/opt/java-debug",
  ...
  ["nvim-dap-python"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/nvim-dap-python",
  ...
  ["nvim-jdtls"] = {
    loaded = true,
    path = "/home/michael/.local/share/nvim/site/pack/packer/start/nvim-jdtls",
  ...
  ["vscode-java-test"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/michael/.local/share/nvim/site/pack/packer/opt/vscode-java-test",
